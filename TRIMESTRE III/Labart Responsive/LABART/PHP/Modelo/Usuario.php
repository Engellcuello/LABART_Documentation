...
class Usuario
{
    ...
    public function verificarCredenciales($Nombre_usuario, $Contraseña)
    {
        ...
        $sql = "SELECT AES_DECRYPT(Contraseña, @encryption_key) AS Contraseña_decrypted FROM usuario WHERE Nombre_usuario = ?";
        $stmt = $this->Conexion->prepare($sql);
        ...
        if ($resultado->num_rows > 0) {
            ...
            $ContraseñaDesencriptada = $fila['Contraseña_decrypted'];
